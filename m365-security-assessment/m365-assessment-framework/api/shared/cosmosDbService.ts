...
export class CosmosDbService {
     ...
     */
    async createAssessment(assessment: Omit<Assessment, 'id' | 'createdDate'>): Promise<Assessment> {
        try {
            ...
            await this.updateCustomerAssessmentInfo(assessment.customerId, assessment.tenantId);
