 ...
 */
class PostgreSQLFirewallManager {
    constructor() {
     ...
     */
    async createFirewallRule(ruleName, startIP, endIP = startIP) {
        try {
     ...
     */
    async setupComprehensiveFirewallRules() {
     ...
     */
    async addSpecificIP(ipAddress, ruleName) {
...
exports.PostgreSQLFirewallManager = PostgreSQLFirewallManager;
