...
exports.assessmentHistoryHandler = void 0;
...
exports.assessmentHistoryHandler = functions_1.app.http('assessmentHistory', {
...
async function handleStoreHistory(request, context, corsHeaders) {
    try {
...
async function handleGetHistory(request, context, tenantId, corsHeaders) {
    try {
...
async function handleCleanupHistory(request, context, tenantId, corsHeaders) {
    try {
        const requestData = await request.json();
